...
const POLICIES = {
    deposit: {
        amount: 10000,
        description: 'Para apartar tu hora debes enviar una reserva de $10.000 pesos, la cual se descuenta del valor total del servicio. Si el pago no se confirma dentro de las proximas 24 horas, la hora se libera automaticamente.'
    },
    payment: {
...
const FAQS = {
    ...
    agendar: () => {
        return `📅 *¿Cómo Agendar tu Cita?*\n\n` +
            ...
            `7️⃣ Si el pago no se confirma dentro de las proximas 24 horas, la hora se libera automaticamente\n\n` +
